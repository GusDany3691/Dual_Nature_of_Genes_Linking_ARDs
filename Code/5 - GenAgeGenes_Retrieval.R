...
AgeingHumans = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/HAGR/genage_human.csv')
AgeingHumans$symbol %>% unique() %>% saveRDS('C:/Users/Usuario/Desktop/Nature/Data/Generated/HAGR/GenAgeMod_Genes.rds')
...
Oma_Mouse = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/OMA/OMA_Mouse.csv')
Oma_Fly = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/OMA/OMA_Fly.csv')
Oma_Worm = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/OMA/OMA_Worm.csv')
Oma_Yeast = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/OMA/OMA_Yeast.csv')

# AGEING AND DIETARY RESTRICTION
AgeingModels = read.csv('C:/Users/Usuario/Desktop/Nature/Data/Retrieved/HAGR/genage_models.csv')
...
eaHumanYeast = OmaFrame(RelationsDataset = Oma_Yeast, ModelSymbol, ModelGenes = aCerevisiae,
                        ModelIDs = cCerevisiaeId, ModelMart, Database = 'entrezgene_id', ModelName)


##### COMBINE HUMAN GENES ###############################################################################################################

ModelAgeingGenes = unique(eaHumanMouse$Human, eaHumanFly$Human, eaHumanWorm$Human, eaHumanYeast$Human)

saveRDS(ModelAgeingGenes, "C:/Users/Usuario/Desktop/Nature/Data/Generated/HAGR/GenAgeMod_Genes.rds")
